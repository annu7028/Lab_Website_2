...
function loadStatsPage()
{
	...
	var rowTotal = document.getElementById("stats_table").rows.length;
	...
	{
		var oppTeam = table.rows[i].cells[1].innerHTML;
		var homeScore = table.rows[i].cells[2].innerHTML;
		var oppScore = table.rows[i].cells[3].innerHTML;
		//type cast the homeScore and oppScore to ints
		var homeScore_int = parseInt(homeScore);
		var oppScore_int = parseInt(oppScore);

		if(homeScore_int > oppScore_int)
		{
		...
		{
			table.rows[i].cells[4].innerHTML = oppTeam;
...
function switchPlayers(playerNum)
{
	...
	var avg_passing_yards = parseInt(players[playerNum].pass_yards/players[playerNum.games_played]);
	var avg_rushing_yards = parseInt(players[playerNum].rushing_yards/players[playerNum].games_played);
	var avg_receiving_yards = parseInt(players[playerNum].receiving_yards/players[playerNum].games_played);
